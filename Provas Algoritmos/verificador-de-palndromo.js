...
// Observação: você precisará remover todos os caracteres não alfanuméricos (pontuação, espaços e símbolos) e 
//transforme tudo na mesma capitalização (letra em minúsculo ou maiúsculo) para verificar se determinada palavra ou frase é um palíndromo.
...
function palindrome(str) {
  str = str.split(/[\s\W_]/).join("").toLowerCase();
  let reverseStr = str.slice().split("").reverse().join("");
